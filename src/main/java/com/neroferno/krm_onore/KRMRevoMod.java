...
import com.neroferno.krm_onore.event.ModVillagers;
import com.neroferno.krm_onore.attachment.ModAttachments;
import com.neroferno.krm_onore.menu.ModMenuTypes;
import com.neroferno.krm_onore.item.ModArmorMaterials;
import com.neroferno.krm_onore.item.ModItems;
import com.neroferno.krm_onore.network.ModNetwork;
...
public class KRMRevoMod {
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        ...
        com.neroferno.krm_onore.seasons.heisei1.Kuuga.init();
        LOGGER.info("Onore Rider — Kamen Rider Engine initialized with {} riders.",
                com.neroferno.krm_onore.engine.RiderRegistry.getAll().size());
    }
}
